class Security {
    ...
    constructor(){
        ...
        this.access1 = createInput("").attribute("placeholder", "Ans");
        ...
        this.access2 =createInput("").attribute("placeholder", "Ans");
        this.access2.position(700,190);
        this.access2.style('background', 'white');
        
        this.access3 = createInput("").attribute("placeholder", "Ans");
